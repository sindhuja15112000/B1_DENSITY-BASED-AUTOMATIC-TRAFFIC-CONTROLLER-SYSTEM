...
1. INSTALL ARDUINO UNO SOFTWARE FOR THE WINDOWS.
2. CREATE A FOLDER NAMED Traffic.
3. OPEN ARDUINO AND COPY THE FOLLOWING CODE AND PASTE IN IT.
4. NAME THE ARDUINO FILE AS TRAFFIC.
5. RUN THE CODE, ONCE IT IS DONE COMPILING, TRANSFER IT ON THE MICROCONTROLLER IN THE KIT.
